...
> Test is 1 Cheatsheet Demo for **Sustain**, this Jekyll theme. Please check the raw content of this file for the markdown usage.
...
<p><a title="test link" href="#">test link</a> . 
<strong>This is strong.</strong> 
<em>This is emphasized.</em> Donec faucibus. Nunc iaculis suscipit dui. 5<sup>3</sup> = 125. Water is H<sub>2</sub>
<cite>The New York Times</cite> (That’s a citation). 
<span style="text-decoration:underline;">Underline.</span> 
</p>

<p><abbr title="Hyper Text Markup Language">HTML</abbr> and <abbr title="Cascading Style Sheets">CSS</abbr>. <code>COPY <var>filename</var></code>. <del>Dinner’s at 5:00.</del> <ins>Let’s make that 7.</ins> 
 <span style="text-decoration:line-through;">text</span> struck.</p>
<hr />
